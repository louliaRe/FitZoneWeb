...
const GymInterface = () => {
  ...
  const [newGym, setNewGym] = useState({
    ...
    img: null,
    has_store: false,
    allow_retrival: false,
    days: null,
    allow_public_posts: false,
    allowed_days_for_registraiton_cancellation: false,
    number_of_clients_allowed: 100,
    allow_public_posts: false,
    allow_public_products: false,
    duration_allowed: 0,
    cut_percentage: 0,
    openHour: "",
    closeHour: "",
    ...
    if (validateForm()) {
      ...
      try {
        const gymData = {
          ...
          allowed_days_for_registraiton_cancellation:
            gym.allowed_days_for_registraiton_cancellation,
  ...
  const validateForm = () => {
    ...
    if (newGym.cut_percentage !== null && newGym.cut_percentage < 0) {
      newErrors.cut_percentage =
        "Cut percentage must be equal to or greater than 0";
    }

    if (
      womanStartHour.isValid() &&
      womanEndHour.isValid() &&
      womanStartHour.isAfter(womanEndHour)
    ) {
    ...
    <Layout>
      <Stack>
        <div className="TB">
          ...
          <Button onClick={handleModalToggle} color="#a1E533">
            Add a New Gym
          </Button>
        </div>
        ...
        >
          ...
          >
            ...
            <Radio.Group
              ...
              withAsterisk
              onChange={(value) =>
                handleChange({ target: { name: "has_store", value } })
              }
            >
              <Group mt="xs">
            ...
            <Radio.Group
              ...
              withAsterisk
              onChange={(value) =>
                handleChange({ target: { name: "allow_retrival", value } })
              }
            >
              <Group mt="xs">
                <Radio value="true" label="Yes" />
            ...
            <TextInput
              ...
              onChange={(event) =>
                handleChange({
                  target: { name: "cut_percentage", value: event.target.value },
                })
              }
              placeholder="3%"
            ...
            <Select
              ...
              onChange={(value) =>
                handleChange({ target: { name: "managerGender", value } })
              }
              required
            />
              ...
              {registration_feeArray.map((fee, index) => (
                <Group key={index} mt="xs">
                  <TextInput
                    ...
                    type="number"
                    value={
                      newGym.registration_fee[index].fee
                        ? newGym.registration_fee[index].fee
                        : 0
                    }
                    onChange={(e) =>
            ...
            <Button type="submit" color="#a1E533" className="submit">
              Add Gym
            </Button>
          </form>
        </Modal>
