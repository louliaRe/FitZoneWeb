...
import { Button, ActionIcon, Modal, TextInput, NumberInput } from '@mantine/core';
...
const VouchersInterface=()=>{
        ...
        <>
            <div>
                <div className={classes.header}>         
                           ...
                           <Button className={classes.btn} onClick={handleClick} color='#a1E533' variant='outline' >Show Points</Button>
                           <ActionIcon onClick={handleAddVoucher} className={classes.icon} color="lime" size="lg" >
                           <Plus size={20} />
                          </ActionIcon>        
          </div>   
           </div>
 ...
 >
   ...
   <NumberInput
     ...
     required
   />
   <Button onClick={handleSave} color='#a1E533' fullWidth style={{ marginTop: '20px' }}>
     Submit
   </Button>
 </Modal>
 </>
