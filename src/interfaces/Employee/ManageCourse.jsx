...
const ManageCourse = () => {
  ...
  const [newCourse, setNewCourse] = useState({
    ...
    image_path: null,
    days_of_week: {},
    allowed_number_for_class: 15,
    allowed_days_to_cancel: 0,
  });
  ...
  useEffect(() => {
    const f_co = async () => {
      setNewA(
        coaches.map((coach) => ({
          label: coach.employee.user.username,
          value: coach.employee.id.toString(),
        }))
      );
    };
  ...
  const handleSaveNew = async () => {
    try {
      ...
      formData.append(
        "registration_fee",
        JSON.stringify(newCourse.registration_fee)
      );
  ...
  return (
    <Layout>
      <Box pos="relative" mt={40}>
        <Stack align="center">
          <Group className={classes.header} align="space-between">
            ...
            <Group>
              ...
              />
              <Button color="lime" onClick={handleAddNewCourse}>
                New Course
              </Button>
            </Group>
          </Group>
            ...
            {currentCourse && (
              <div>
                ...
                <NumberInput
                  ...
                  onChange={(e) => {
                    handleChange({
                      target: { name: "allowed_number_for_class", value: e },
                    });
                  }}
                />
                ...
                <NumberInput
                  ...
                  onChange={(e) => {
                    handleChange({
                      target: { name: "allowed_days_to_cancel", value: e },
                    });
                  }}
                />
                <DateInput
          ...
          >
            <div>
              ...
              <Select
                ...
                name="trainer_id"
                onChange={(e) =>
                  handleChange({ target: { name: "trainer_id", value: e } })
                }
              />
              <TextInput
                label="Description"
              ...
              <MultiSelect
                ...
                onChange={(value) =>
                  handleChange({ target: { name: "days_of_week", value } })
                }
              />
              <Select
                label="Hall"
                ...
                onChange={(e) =>
                  handleChange({ target: { name: "hall", value: e } })
                }
              />
              <NumberInput
                ...
                onChange={(e) =>
                  handleChange({
                    target: { name: "registration_fee", value: e },
                  })
                }
              />
              <FileInput
