  ...
  try {
    ...
    throw new Error(
      error.response
        ...
        : "An error occurred while adding the coach"
    );
  }
};
...
export const getCoaches = async (accessToken, id) => {
  try {
    ...
    console.log("get coaches", response.data);
...
export const updateCoach = async (id, data) => {
  try {
    ...
    throw new Error(
      error.response
        ? error.response.data.message
        : "An error occurred while updating the coach"
    );
  }
};
...
export const getCourses = async (accessToken, id) => {
  console.log(`${API_URL}/classes/${id}/`);
  try {
    ...
    throw new Error(
      error.respons
        ? error.respons.config
        : "An error occured while getting courses"
    );
  }
};
...
export const UpdatePost = async (accessToken, postId, gym_id, editedPost) => {
  ...
  try {
    ...
    const res = await axios.put(
      `${API_URL}/community/${postId}/${gym_id}/`,
      editedPost,
      {
        headers: {
          Authorization: `Bearer ${accessToken}`,
